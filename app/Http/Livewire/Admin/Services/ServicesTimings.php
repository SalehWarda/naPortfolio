...
class ServicesTimings extends Component
{
    ...
    public function modalData()
    {
        ...
        $input['service_timings_from'] =Carbon::parse( $this->service_timings_from)->format('Y-m-d h:i A');
        $input['service_timings_to'] =Carbon::parse( $this->service_timings_to)->format('Y-m-d h:i A');
    ...
    public function editTime($id)
    {
        ...
        $this->service_timings_from = Carbon::parse( $time->service_timings_from)->format('Y-m-d h:i A');
        $this->service_timings_to = Carbon::parse( $time->service_timings_to)->format('Y-m-d h:i A');
        $this->time_id = $id;
    ...
    public function show_delete_time($id)
    {
        ...
        $this->service_timings = Carbon::parse( $time->service_timings_from)->format('Y-m-d h:i A');
    ...
    {
        $timings = ServiceTiming::with('service')->paginate(10);
