...
<div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            @forelse($services as $service)
                                ...
                                <!--  Edit Service Modal -->
                                <div wire:ignore.self class="modal fade " tabindex="-1" role="dialog" id="edit_service"
    ...
    <div wire:ignore.self class="modal fade" tabindex="-1" role="dialog" id="delete_service"
    ...
    <!--  Add Service Modal -->
    <div wire:ignore.self class="modal fade" tabindex="-1" role="dialog" id="add_service"
         aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc"><span
                                        class="text-danger">  {{trans('services.Note')}} : </span>
                                    {{trans('services.Note_Message')}}
                                </p>
                                <div class="d-flex py-3 ">
