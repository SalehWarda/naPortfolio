                            ...
                            <form action="{{route('site.register.user')}}" method="post">
                                ...
                                <div class="sign__input-wrapper mb-25">
                                    ...
                                    <div class="sign__input">
                                        <input name="first_name" type="text" placeholder="{{trans('site/register.First_name')}}">
                                ...
                                <div class="sign__input-wrapper mb-25">
                                    ...
                                    <div class="sign__input">
                                        <input name="last_name" type="text" placeholder="{{trans('site/register.Last_name')}}">
                                        <i class="fal fa-user"></i>
                                        @error('last_name')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="sign__input-wrapper mb-25">
                                    ...
                                    <div class="sign__input">
                                        <input name="username" type="text" placeholder="{{trans('site/register.User_name')}}">
                                        <i class="fal fa-user"></i>
                                        @error('username')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="sign__input-wrapper mb-25">
                                    ...
                                    <div class="sign__input">
                                        <input name="email" type="email" placeholder="{{trans('site/register.Email')}}">
                                ...
                                <div class="sign__input-wrapper mb-25">
                                    ...
                                    <div class="sign__input">
                                        <input name="mobile" type="text" placeholder="{{trans('site/register.Mobile')}}">
                                ...
                                <div class="sign__input-wrapper mb-25">
                                    ...
                                    <div class="sign__input">
                                        <input name="password" type="password" placeholder="{{trans('site/register.Password')}}">
                                ...
                                <div class="sign__input-wrapper mb-10">
                                    ...
                                    <div class="sign__input">
                                        <input type="password" name="password_confirmation" placeholder="{{trans('site/register.Confirm_password')}}">
                                        <i class="fal fa-lock"></i>
